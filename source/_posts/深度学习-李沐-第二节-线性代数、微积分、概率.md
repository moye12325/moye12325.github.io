...
定义两个标量与标量的运算
![深度学习-李沐-第二节-线性代数、微 配图 1](/images/qiniu/c328dc90.png)
...
运算结果：  
![深度学习-李沐-第二节-线性代数、微 配图 2](/images/qiniu/d320f651.png)

两个矩阵的按元素乘法称为Hadamard积（Hadamard product）（数学符号![深度学习-李沐-第二节-线性代数、微 配图 3](/images/qiniu/a67b03b3.png)）A * B运算结果：
![深度学习-李沐-第二节-线性代数、微 配图 4](/images/qiniu/fd5efe68.png)
将张量乘以或加上一个标量不会改变张量的形状，其中张量的每个元素都将与标量相加或相乘。如下：
![深度学习-李沐-第二节-线性代数、微 配图 5](/images/qiniu/9fcc5dd5.png)  


### 降维

![深度学习-李沐-第二节-线性代数、微 配图 6](/images/qiniu/7ccecf4b.png)
...
**L2范数：**向量元素平⽅和的平⽅根
![深度学习-李沐-第二节-线性代数、微 配图 7](/images/qiniu/d46b71f3.png)  
...
**L1范数：**为向量元素的绝对值之和
![深度学习-李沐-第二节-线性代数、微 配图 8](/images/qiniu/4cff181c.png)  
...
![深度学习-李沐-第二节-线性代数、微 配图 9](/images/qiniu/a2aea73d.png)
...
![深度学习-李沐-第二节-线性代数、微 配图 10](/images/qiniu/86bcb907.png)  
前提是f、g均可微，C为常熟

### 偏导数

![深度学习-李沐-第二节-线性代数、微 配图 11](/images/qiniu/e12565cb.png)

### 梯度

梯度讲解视频：[https://www.bilibili.com/video/BV1sW411775X](https://www.bilibili.com/video/BV1sW411775X)
![深度学习-李沐-第二节-线性代数、微 配图 12](/images/qiniu/b3359be7.png)
...
![深度学习-李沐-第二节-线性代数、微 配图 13](/images/qiniu/096318c7.png)
