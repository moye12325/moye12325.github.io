---
description: "通过多尺度特征块，单发多框检测生成不同大小的锚框，并通过预测边界框的类别和偏移量来检测大小不同的目标"
title: 深度学习-李沐-第十三节-单发多框检测（SSD）与yolo
date: 2022-08-16 15:00:46
categories: [深度学习]
tags: ['性能优化', '深度学习', '神经网络', '算法']
---
# 单发多框检测（SSD）与yolo

通过多尺度特征块，单发多框检测生成不同大小的锚框，并通过预测边界框的类别和偏移量来检测大小不同的目标
![深度学习-李沐-第十三节-单发多框检 配图 1](https://qiniu.kanes.top/blog/bb0226a0.png)
![深度学习-李沐-第十三节-单发多框检 配图 2](https://qiniu.kanes.top/blog/0b6f779d.png)

---

![深度学习-李沐-第十三节-单发多框检 配图 3](https://qiniu.kanes.top/blog/ec5d3d57.png)
