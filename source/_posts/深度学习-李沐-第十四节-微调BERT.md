---
description: "1. 一方面，在提出时，BERT改进了各种自然语言处理任务的技术水平。 2. 另一方面，原始BERT模型的两个版本分别带有1.1亿和3.4亿个参数。 3. 因此，当有足够的计算资源时，我们可以考虑为下游自然语言处理应用微调BERT。"
title: 深度学习-李沐-第十四节-微调BERT
date: 2022-08-16 15:00:46
categories: [深度学习]
tags: ['NLP', 'Transformer', '数据结构', '深度学习']
---
# 微调BERT
...
![深度学习-李沐-第十四节-微调BER 配图 1](/images/qiniu/3bf5d020.png)
...
3. “A woman is dancing.”（一个女人在跳舞。），”A man is talking.”（“一个人在说话。”），0.000分。
   ![深度学习-李沐-第十四节-微调BER 配图 2](/images/qiniu/cd8e4402.png)
...
![深度学习-李沐-第十四节-微调BER 配图 3](/images/qiniu/11bcf2f7.png)
...
![深度学习-李沐-第十四节-微调BER 配图 4](/images/qiniu/57b30573.png)
