...
![深度学习-李沐-第十三节-样式迁移 配图 1](/images/qiniu/05c982c9.png)
![深度学习-李沐-第十三节-样式迁移 配图 2](/images/qiniu/00a73258.png)
...
第二层输出图像的内容特征  
![深度学习-李沐-第十三节-样式迁移 配图 3](/images/qiniu/c1c3bb3d.png)
损失函数构成：
...
![深度学习-李沐-第十三节-样式迁移 配图 4](/images/qiniu/991d8288.png)
...
![深度学习-李沐-第十三节-样式迁移 配图 5](/images/qiniu/85d906aa.png)
