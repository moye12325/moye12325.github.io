---
description: "自动将一个图像中的风格应用在另一图像之上 一张是内容图像，另一张是风格图像，使用神经网络修改内容图像，使其在风格上接近风格图像"
...
![深度学习-李沐-第十三节-样式迁移 配图 1](https://qiniu.kanes.top/blog/05c982c9.png)
![深度学习-李沐-第十三节-样式迁移 配图 2](https://qiniu.kanes.top/blog/00a73258.png)
...
第二层输出图像的内容特征  
![深度学习-李沐-第十三节-样式迁移 配图 3](https://qiniu.kanes.top/blog/c1c3bb3d.png)
损失函数构成：
...
![深度学习-李沐-第十三节-样式迁移 配图 4](https://qiniu.kanes.top/blog/991d8288.png)
...
![深度学习-李沐-第十三节-样式迁移 配图 5](https://qiniu.kanes.top/blog/85d906aa.png)
