---
description: "循环神经网络编码器使用长度可变的序列作为输入， 将其转换为固定形状的隐状态。 为了连续生成输出序列的词元， 独立的循环神经网络解码器是基于输入序列的编码信息 和输出序列已经看见的或者生成的词元来预测下一个词元。"
...
![深度学习-李沐-第九节-序列到序列学 配图 1](/images/qiniu/313de9c7.png) 
循环神经网络编码器使用长度可变的序列作为输入， 将其转换为固定形状的隐状态。  
 为了连续生成输出序列的词元， 独立的循环神经网络解码器是基于输入序列的编码信息 和输出序列已经看见的或者生成的词元来预测下一个词元。

---

![深度学习-李沐-第九节-序列到序列学 配图 2](/images/qiniu/82f25ad7.png)

---

![深度学习-李沐-第九节-序列到序列学 配图 3](/images/qiniu/07fdec68.png)
...
![深度学习-李沐-第九节-序列到序列学 配图 4](/images/qiniu/2eed9024.png)
