...
![深度学习-李沐-第九节-门控循环单元 配图 1](https://qiniu.kanes.top/blog/3f8ce46c.png)
GRU的输入输出结构与普通的RNN是一样的。

### GRU的内部结构

![深度学习-李沐-第九节-门控循环单元 配图 2](https://qiniu.kanes.top/blog/1b66ac48.png)
首先，我们先通过上一个传输下来的状态 h( t-1) 和当前节点的输入xt来获取两个门控状态。  
其中 r 控制重置的门控（reset gate）， z为控制更新的门控（update gate）。  

![深度学习-李沐-第九节-门控循环单元 配图 3](https://qiniu.kanes.top/blog/e05e7485.png)
![深度学习-李沐-第九节-门控循环单元 配图 4](https://qiniu.kanes.top/blog/402bd78f.png)
