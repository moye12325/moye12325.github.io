---
description: "1. 使用高斯核来对查询和键之间的关系建模 2. 高斯核指数部分视为注意力评分函数（attention scoring function）"
...
![深度学习-李沐-第十节-注意力评分函 配图 1](https://qiniu.kanes.top/blog/81365328.png)
...
![深度学习-李沐-第十节-注意力评分函 配图 2](https://qiniu.kanes.top/blog/5144854a.png)
