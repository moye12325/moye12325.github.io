...
summary: >
  ...
  访问以（250,250）为中心的第一个锚框。 它有四个元素：锚框左上角的轴坐标和右下角的轴坐标。 将两个轴的坐标各分别除以图像的宽度和高度后，所得的值介于0和1
---
# 锚框

以每个像素为中心，生成多个缩放比和宽高比（aspect ratio）不同的边界框。 这些边界框被称为锚框（anchor box）
![](https://qiniu.kanes.top/blog/2cf9ea23.png)

### 生成多个锚框

![](https://qiniu.kanes.top/blog/3ac0874f.png)
...
![](https://qiniu.kanes.top/blog/0a38d326.png)
...
![](https://qiniu.kanes.top/blog/2b95df3f.png)
![](https://qiniu.kanes.top/blog/07c75376.png)
...
![](https://qiniu.kanes.top/blog/b5608d57.png)
...
![](https://qiniu.kanes.top/blog/3a3c0ad0.png)
...
![](https://qiniu.kanes.top/blog/b6933e58.png)
