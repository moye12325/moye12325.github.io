...
![Chinese Extractive 配图 1](/images/qiniu/ed21a111.png)
...
![Chinese Extractive 配图 2](/images/qiniu/22953979.png)
...
![Chinese Extractive 配图 3](/images/qiniu/2ca3eaa9.png)
...
![Chinese Extractive 配图 4](/images/qiniu/34aa9338.png)
...
![Chinese Extractive 配图 5](/images/qiniu/3f85b615.png)
由此可见15是个不错的参数

### Apply linear learning rate decay

![Chinese Extractive 配图 6](/images/qiniu/1ceb5023.png)
self.doc_stride = 15
![Chinese Extractive 配图 7](/images/qiniu/7bdcf4d8.png)
...
![Chinese Extractive 配图 8](/images/qiniu/fc3c1a47.png)
**Parameters：**
...
![Chinese Extractive 配图 9](/images/qiniu/680d2aba.png)

更改warmup版本的lr，发现学习率不宜过大
![Chinese Extractive 配图 10](/images/qiniu/32393e8b.png)
...
![Chinese Extractive 配图 11](/images/qiniu/e8a742df.png)

新模型内存很大，降低batch_size。（或者使用助教在视频中提到的技巧Gradient Accumulation来解决batch_size不够的情况）
![Chinese Extractive 配图 12](/images/qiniu/9436422d.png)

preprocessing
![Chinese Extractive 配图 13](/images/qiniu/050e4d3e.png)
![Chinese Extractive 配图 14](/images/qiniu/4f51dc53.png)
...
![Chinese Extractive 配图 15](/images/qiniu/711546ff.png)
...
![Chinese Extractive 配图 16](/images/qiniu/d03f0fa3.png)
...
![Chinese Extractive 配图 17](/images/qiniu/624def81.png)

![Chinese Extractive 配图 18](/images/qiniu/5ae79dc4.png)
![Chinese Extractive 配图 19](/images/qiniu/c07e9818.png)

处理结果集中的特殊字符
![Chinese Extractive 配图 20](/images/qiniu/64f26ad0.png)
