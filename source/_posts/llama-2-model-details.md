...
summary: >
  ...
  Meta开发并发布了Llama
  2系列的大型语言模型（LLMs），这是一系列预训练和微调的生成文本模型，参数规模从70亿到700亿不等。我们经过微调的LLMs称为Llama-2-Chat，专为对话场景进行了优化。在我们测试的大多数基准测试中，Llama-2-Chat模型表现优于开源的聊天模型，并且在我们的人类评估中在帮助性和安全性方面与一些流行的闭源模型（如ChatGPT和PaLM）相
---
# **模型细节**
