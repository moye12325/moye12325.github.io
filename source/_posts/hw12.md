...
summary: >
  ...
  对于实现这个方法，宏毅老师也在课堂上讲过，当产生一个Action的时候，当前的Action会对未来的一些Action产生一定的影响，假设现在产生了三个动作每个Action记a1,a2,a3，所得到的分数是r1,r2,r3，则a1所得到的最终分数是r1+0.99r2+0.99^2r3，a2所得到的分数是r2+0.99r3.
---
# HW12
