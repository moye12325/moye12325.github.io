...
summary: >
  我们可以证明，对于前
  <math><semantics><mrow><mi>i</mi></mrow><annotation>i</annotation></semantics></math>i
  个数构成的所有区间，其“数字凸包区间”的并恰好是一个连续区间
  <math><semantics><mrow><mo>\[</mo><msub><mi>P</mi><mi>min</mi><mo>⁡</mo
---
