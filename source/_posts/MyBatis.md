...
categories: [Web开发]
tags: ['Git', 'Java', 'MyBatis', 'MySQL', '性能优化', '机器学习']
---
...
![MyBatis知识总结 配图 1](/images/qiniu/01.%20Maven%E7%AE%80%E4%BB%8B%E5%92%8C%E5%BF%AB%E9%80%9F%E5%85%A5%E9%97%A8_image_1.png)
...
2. 项目搭建和准备
    ...
    1. 项目搭建
        ...
        ![MyBatis知识总结 配图 2](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_2.png)
...
3. 准备Mapper接口和MapperXML文件
    ...
    ![MyBatis知识总结 配图 3](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_3.png)
...
6. SqlSession和HttpSession区别
    ...
    - SqlSession：不依赖Web服务器，属于持久化层。
        ...
        - 代表Java程序和数据库之间的会话。 ![MyBatis知识总结 配图 4](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_4.png)
...
![MyBatis知识总结 配图 5](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_5.png)

#### 2.1.3 **${}形式**

${}形式传参，底层Mybatis做的是字符串拼接操作。

![MyBatis知识总结 配图 6](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_6.png)
...
![MyBatis知识总结 配图 7](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_7.png)
...
对应关系
![MyBatis知识总结 配图 8](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_8.png)
...
![MyBatis知识总结 配图 9](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_9.png)
...
对应关系
![MyBatis知识总结 配图 10](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_10.png)
...
```
    ...
    ![MyBatis知识总结 配图 11](/images/qiniu/Pasted image 20240319224837.png)
...
```
    ...
    ![MyBatis知识总结 配图 12](/images/qiniu/Pasted image 20240319225007.png)
...
- Mapper 配置文件放在 Mapper 接口所在的包内
    ...
    - 可以在sources下创建mapper接口包一致的文件夹结构存放mapperxml文件
        ...
        ![MyBatis知识总结 配图 13](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_11.png)
        
        ![MyBatis知识总结 配图 14](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_12.png)
...
2. 使用 IntelliJ IDEA连接数据库
    ...
    - 连接数据库
        ...
        ![MyBatis知识总结 配图 15](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_13.png)
        
    - 填写信息
        
        ![MyBatis知识总结 配图 16](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_14.png)
        
    - 展示库表
        
        ![MyBatis知识总结 配图 17](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_15.png)
        
    - 逆向工程使用
        
        ![MyBatis知识总结 配图 18](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_16.png)
        
        ![MyBatis知识总结 配图 19](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_17.png)
        
        ![MyBatis知识总结 配图 20](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_18.png)
        
3. 查看生成结果
    
    ![MyBatis知识总结 配图 21](/images/qiniu/01. MyBatis提高持久层数据处理效率_image_19.png)
