---
description: "一个处理器（也被称为CPU），它除了能够运行操作系统和许多其他功能之外，还能够执行我们给它的程序，通常由8个或更多个核心组成。 内存（随机访问存储，RAM）用于存储和检索计算结果，如权重向量和激活参数，以及训练数据。"
title: 深度学习-李沐-第十二节-硬件、CPU、GPU
date: 2022-08-16 15:00:46
categories: [深度学习]
tags: ['性能优化', '机器学习', '深度学习', '算法']
---
# 硬件、CPU、GPU
...
![深度学习-李沐-第十二节-硬件、CP 配图 1](/images/qiniu/6f3e6e7e.png)
...
![深度学习-李沐-第十二节-硬件、CP 配图 2](/images/qiniu/004e6ff3.png)

### GPU和其他加速卡

![深度学习-李沐-第十二节-硬件、CP 配图 3](/images/qiniu/0b97cbfc.png)
一个绿点可开一个线程 上千个线程

### GPU VS CPU

![深度学习-李沐-第十二节-硬件、CP 配图 4](/images/qiniu/d12c13b2.png)
