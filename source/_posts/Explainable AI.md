...
![Explainable AI 配图 1](/images/qiniu/fc9470ea.png)
白马做出算术题是因为它察觉到周围观众的情绪而做对，并不是因为真的会做数学题


## Why we need Explainable ML?

![Explainable AI 配图 2](/images/qiniu/7b737aa7.png)
...
![Explainable AI 配图 3](/images/qiniu/9c0623de.png)
...
![Explainable AI 配图 4](/images/qiniu/cafccf8f.png)  
...
![Explainable AI 配图 5](/images/qiniu/4a3963fa.png)


什么叫做好的 Explanation,好的 Explanation就是人能接受的 Explanation,人就是需要一个理由让我们觉得高兴,而到底是让谁高兴呢  


![Explainable AI 配图 6](/images/qiniu/6f651cf8.png)


## Explainable ML

![Explainable AI 配图 7](/images/qiniu/71e12259.png)

### Local Explanation

Local Explanation：假设我们有一个 Image 的 Classify,我们给它一张图片,它判断说它是一只猫,问题是,為什么,或者机器要回答问题是,為什么你觉得这张图片是一只猫,它根据某一张图片来回答问题  

![Explainable AI 配图 8](/images/qiniu/99fe9115.png)
![Explainable AI 配图 9](/images/qiniu/7d7278b1.png)
![Explainable AI 配图 10](/images/qiniu/c58509dc.png)
...
![Explainable AI 配图 11](/images/qiniu/0de7f6db.png)

![Explainable AI 配图 12](/images/qiniu/6e4febe0.png)

![Explainable AI 配图 13](/images/qiniu/396892c9.png)
