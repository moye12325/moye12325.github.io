---
description: "以每个像素为中心，生成多个缩放比和宽高比（aspect ratio）不同的边界框。 这些边界框被称为锚框（anchor box）"
title: 深度学习-李沐-第十三节-锚框
date: 2022-08-16 15:00:46
categories: [深度学习]
tags: ['PyTorch', 'Python', '深度学习', '计算机视觉']
---
# 锚框

以每个像素为中心，生成多个缩放比和宽高比（aspect ratio）不同的边界框。 这些边界框被称为锚框（anchor box）
![深度学习-李沐-第十三节-锚框 配图 1](https://qiniu.kanes.top/blog/2cf9ea23.png)

### 生成多个锚框

![深度学习-李沐-第十三节-锚框 配图 2](https://qiniu.kanes.top/blog/3ac0874f.png)
...
![深度学习-李沐-第十三节-锚框 配图 3](https://qiniu.kanes.top/blog/0a38d326.png)
...
![深度学习-李沐-第十三节-锚框 配图 4](https://qiniu.kanes.top/blog/2b95df3f.png)
![深度学习-李沐-第十三节-锚框 配图 5](https://qiniu.kanes.top/blog/07c75376.png)
...
![深度学习-李沐-第十三节-锚框 配图 6](https://qiniu.kanes.top/blog/b5608d57.png)
...
![深度学习-李沐-第十三节-锚框 配图 7](https://qiniu.kanes.top/blog/3a3c0ad0.png)
...
![深度学习-李沐-第十三节-锚框 配图 8](https://qiniu.kanes.top/blog/b6933e58.png)
