...
- ![HW11 配图 1](/images/qiniu/78c67770.png)
- ![HW11 配图 2](/images/qiniu/bb7a74bb.png)
- ![HW11 配图 3](/images/qiniu/7cf1f46b.png)
- ![HW11 配图 4](/images/qiniu/da0b06c8.png)

## baseline

![HW11 配图 5](/images/qiniu/3ee5f64c.png)
...
- ![HW11 配图 6](/images/qiniu/0ab7389e.png)

## 试验记录

### 初始记录 0.53894

![HW11 配图 7](/images/qiniu/3138842a.png)
...
故而，整个网络的优化目标也相应地由两部分构成：在有label的源域数据上的分类误差(![HW11 配图 8](/images/qiniu/d3d0c313.png))，以及对两个领域数据的判别误差(![HW11 配图 9](/images/qiniu/1e5a393a.png) )。优化目标由下式形象地表示：![HW11 配图 10](/images/qiniu/9135bad2.png)

lambda是权衡网络适配的权重的一个参数，可以人工给定。![HW11 配图 11](/images/qiniu/d3d0c313.png)很好理解，就是网络的分类误差； ![HW11 配图 12](/images/qiniu/1e5a393a.png)表示两个领域的距离。


**换而言之：lambda在一定范围内越大，抽取公共特征的能力就会越强，带来的问题是降低抽取模型特征的能力**

![HW11 配图 13](/images/qiniu/12159035.png)
...
![HW11 配图 14](/images/qiniu/0a78acaa.png)
![HW11 配图 15](/images/qiniu/cf25d883.png)
![HW11 配图 16](/images/qiniu/0fca83fd.png)


![HW11 配图 17](/images/qiniu/c643669e.png)
...
![HW11 配图 18](/images/qiniu/106b953e.png)
...
![HW11 配图 19](/images/qiniu/e4f659eb.png)
