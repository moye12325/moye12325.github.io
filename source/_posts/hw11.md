---
description: "- 通过使用Domain Adaptation的方法将有label的真实照片（5000）来预测没有label的黑白的图案（100000）物体的类别。"
title: HW11
date: 2022-08-16 15:01:08
categories: [机器学习]
tags: ['性能优化', '测试', '神经网络', '算法']
---
# HW11
...
- ![HW11 配图 1](https://qiniu.kanes.top/blog/78c67770.png)
- ![HW11 配图 2](https://qiniu.kanes.top/blog/bb7a74bb.png)
- ![HW11 配图 3](https://qiniu.kanes.top/blog/7cf1f46b.png)
- ![HW11 配图 4](https://qiniu.kanes.top/blog/da0b06c8.png)

## baseline

![HW11 配图 5](https://qiniu.kanes.top/blog/3ee5f64c.png)
...
- ![HW11 配图 6](https://qiniu.kanes.top/blog/0ab7389e.png)

## 试验记录

### 初始记录 0.53894

![HW11 配图 7](https://qiniu.kanes.top/blog/3138842a.png)
...
故而，整个网络的优化目标也相应地由两部分构成：在有label的源域数据上的分类误差(![HW11 配图 8](https://qiniu.kanes.top/blog/d3d0c313.png))，以及对两个领域数据的判别误差(![HW11 配图 9](https://qiniu.kanes.top/blog/1e5a393a.png) )。优化目标由下式形象地表示：![HW11 配图 10](https://qiniu.kanes.top/blog/9135bad2.png)

lambda是权衡网络适配的权重的一个参数，可以人工给定。![HW11 配图 11](https://qiniu.kanes.top/blog/d3d0c313.png)很好理解，就是网络的分类误差； ![HW11 配图 12](https://qiniu.kanes.top/blog/1e5a393a.png)表示两个领域的距离。


**换而言之：lambda在一定范围内越大，抽取公共特征的能力就会越强，带来的问题是降低抽取模型特征的能力**

![HW11 配图 13](https://qiniu.kanes.top/blog/12159035.png)
...
![HW11 配图 14](https://qiniu.kanes.top/blog/0a78acaa.png)
![HW11 配图 15](https://qiniu.kanes.top/blog/cf25d883.png)
![HW11 配图 16](https://qiniu.kanes.top/blog/0fca83fd.png)


![HW11 配图 17](https://qiniu.kanes.top/blog/c643669e.png)
...
![HW11 配图 18](https://qiniu.kanes.top/blog/106b953e.png)
...
![HW11 配图 19](https://qiniu.kanes.top/blog/e4f659eb.png)
