...
![NLP自监督学习 配图 1](https://qiniu.kanes.top/blog/70724fa1.png)
各种任务上都可以做

## Self-supervised Learning

“自监督学习”数据本身没有标签，所以属于无监督学习；但是训练过程中实际上“有标签”，标签是“自己生成的”。把训练数据分为“两部分”，一部分作为作为“输入数据、另一部分作为“标注”。
![NLP自监督学习 配图 2](https://qiniu.kanes.top/blog/882534dd.png)
...
![NLP自监督学习 配图 3](https://qiniu.kanes.top/blog/c37f499b.png)
...
![NLP自监督学习 配图 4](https://qiniu.kanes.top/blog/bead0a33.png)
...
![NLP自监督学习 配图 5](https://qiniu.kanes.top/blog/61efce88.png)

为了测试Self-supervised学习的能力，通常，会在一个任务集上测试它的准确性，取其平均值得到总分。
![NLP自监督学习 配图 6](https://qiniu.kanes.top/blog/45312115.png)

### How to use BERT – Case 1

![NLP自监督学习 配图 7](https://qiniu.kanes.top/blog/ef4657de.png)
...
![NLP自监督学习 配图 8](https://qiniu.kanes.top/blog/4c8083e4.png)
...
![NLP自监督学习 配图 9](https://qiniu.kanes.top/blog/efc89e64.png)
给它两个句子，我们在这两个句子之间放一个特殊的标记SEP，并在最开始放CLS标记。最终考察CLS标记对应的输出向量，将其放入Linear transform的输入得到分类。
![NLP自监督学习 配图 10](https://qiniu.kanes.top/blog/be37e570.png)
...
![NLP自监督学习 配图 11](https://qiniu.kanes.top/blog/58564029.png)

![NLP自监督学习 配图 12](https://qiniu.kanes.top/blog/01ceade8.png)

计算这个橙色向量和那些与document相对应的输出向量（黄色向量）的内积,计算内积,通过softmax函数，找到数值最大的位置，即为答案的开始位置。

![NLP自监督学习 配图 13](https://qiniu.kanes.top/blog/9fb80f64.png)
蓝色向量类似找到答案的结尾位置。

## Why does BERT work?

每个文本都有一个对应的向量，称之为embedding
![NLP自监督学习 配图 14](https://qiniu.kanes.top/blog/f12a57d8.png)
![NLP自监督学习 配图 15](https://qiniu.kanes.top/blog/2211ecd5.png)
![NLP自监督学习 配图 16](https://qiniu.kanes.top/blog/eacc087b.png)


![NLP自监督学习 配图 17](https://qiniu.kanes.top/blog/b5d53f88.png)
了解一次词汇取决于他的上下文。W2遮起来，看上下文预测W2。


![NLP自监督学习 配图 18](https://qiniu.kanes.top/blog/411c16b2.png)
![NLP自监督学习 配图 19](https://qiniu.kanes.top/blog/e733f89f.png)
![NLP自监督学习 配图 20](https://qiniu.kanes.top/blog/3058f37f.png)
...
![NLP自监督学习 配图 21](https://qiniu.kanes.top/blog/2d069bc6.png)
![NLP自监督学习 配图 22](https://qiniu.kanes.top/blog/cd9905b9.png)
![NLP自监督学习 配图 23](https://qiniu.kanes.top/blog/c5382466.png)
英文训练，能回答中文的测试集

原因：  
![NLP自监督学习 配图 24](https://qiniu.kanes.top/blog/a49e0d68.png)
![NLP自监督学习 配图 25](https://qiniu.kanes.top/blog/c6e59821.png)
不同的语言并没有那么大的差异。无论你用中文还是英文显示，对于具有相同含义的单词，它们的embedding都很接近。

数据量是一个非常关键的因素。资源大才能够被观察到。

![NLP自监督学习 配图 26](https://qiniu.kanes.top/blog/aa089946.png)
![NLP自监督学习 配图 27](https://qiniu.kanes.top/blog/fb9f2328.png)
![NLP自监督学习 配图 28](https://qiniu.kanes.top/blog/2443e159.png)
...
![NLP自监督学习 配图 29](https://qiniu.kanes.top/blog/f5ba0407.png)
给个token，输出一个embedding名为h1，用这个embedding预测下一个出现的token是什么，根据这笔资料，下一个出现的应该是台。再拿台作为token去预测下一个。

---

GPT可以把一句话补完
![NLP自监督学习 配图 30](https://qiniu.kanes.top/blog/2a57be90.png)


---

![NLP自监督学习 配图 31](https://qiniu.kanes.top/blog/8ae10095.png)
GPT给前半段文字，给几个例子做翻译
![NLP自监督学习 配图 32](https://qiniu.kanes.top/blog/4f9f9120.png)
正确率有点低
![NLP自监督学习 配图 33](https://qiniu.kanes.top/blog/33f0a5d9.png)
