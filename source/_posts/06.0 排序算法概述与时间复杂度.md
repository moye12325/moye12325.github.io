---
description: "在计算机科学领域，排序是一项基础而重要的任务。排序算法用于将一组数据按照一定顺序排列，以提高后续操作的效率。排序算法分为内部排序和外部排序，同时在选择排序算法时需要考虑时间复杂度和空间复杂度。"
title: 06.0 排序算法概述与时间复杂度
date: 2024-07-22 17:03:01
categories: [数据结构与算法]
tags: ['Python', '算法']
---
# 排序算法概述
...
![06.0 排序算法概述与时间复杂度 配图 1](https://qiniu.kanes.top/blog/06排序算法概述与时间复杂度_image_1.png)
...
![06.0 排序算法概述与时间复杂度 配图 2](https://qiniu.kanes.top/blog/06排序算法概述与时间复杂度_image_2.png)
...
![06.0 排序算法概述与时间复杂度 配图 3](https://qiniu.kanes.top/blog/06排序算法概述与时间复杂度_image_3.png)
...
![06.0 排序算法概述与时间复杂度 配图 4](https://qiniu.kanes.top/blog/06排序算法概述与时间复杂度_image_4.png)
