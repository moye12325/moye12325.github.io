---
description: "思路分析： 1. 通过一个index索引遍历表达式 2. 发现数字，入数字栈 3. 发现是符号： 3.1 如果当前的符号栈为空，则直接入栈 3.2 符号栈不为空，有操作符，则进行比较。"
...
![04.1 使用栈完成计算功能 配图 1](https://qiniu.kanes.top/blog/4.1使用栈完成计算功能_image_1.png)  
