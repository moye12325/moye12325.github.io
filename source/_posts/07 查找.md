---
description: "顺序搜索是一种简单直观的搜索算法，它按顺序逐个检查数组中的元素，直到找到目标元素或遍历整个数组。其时间复杂度为O(n)，适用于小型数据集。"
title: 07 查找
...
![07 查找 配图 1](https://qiniu.kanes.top/blog/07查找_image_1.png)
...
![07 查找 配图 2](https://qiniu.kanes.top/blog/07查找_image_2.png)
