---
description: "由于我们通常使用小卷积核，因此对于任何单个卷积，我们可能只会丢失几个像素。 但随着我们应用许多连续卷积层，累积丢失的像素数就多了。 解决这个问题的简单方法即为填充（padding）。"
...
![深度学习-李沐-第六节-填充、步幅、 配图 1](https://qiniu.kanes.top/blog/dc02f128.png)
![深度学习-李沐-第六节-填充、步幅、 配图 2](https://qiniu.kanes.top/blog/96e80c8a.png)
...
![深度学习-李沐-第六节-填充、步幅、 配图 3](https://qiniu.kanes.top/blog/f7ca27dd.png)
代码实现
...
![深度学习-李沐-第六节-填充、步幅、 配图 4](https://qiniu.kanes.top/blog/2efbf460.png)
